...
| P7 | Recovery, packaging, upgrades, release and deployment | Supported browser/host matrix; release and Pages evidence | Complete for the tested release scope: published Connector alpha 101-test checks, independent install/discovery/removal with retained data, host/runtime lifecycle, Network recovery deployment and production Chrome receipt/disconnect/retention passed; broader compatibility is not advertised, and P2 real existing-App authorization still prevents full-goal acceptance |
